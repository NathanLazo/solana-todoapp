...
import { PROGRAM_ID } from "~/web3/constants";
import { IDL as profileIdl } from "~/web3/idl";
...
import { authorFilter } from "~/lib/authorFilter";
...
export function useTodo() {
  ...
  const program = useMemo(() => {
    if (anchorWallet) {
      ...
      return new anchor.Program(profileIdl, PROGRAM_ID, provider);
    }
